...
//    func fetchCountries(component:String, handler: @escaping (CountriesWrapper?, Error?) -> Void ){
//        
//        self.singleObjectGetRequest(url: component, model: CountriesWrapper.self, debug: false) { (res, err) in
//            
//            if err == nil {
//                handler(res, nil)
//                
